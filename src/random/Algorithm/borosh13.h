...
namespace borosh13
{
	#define BOROSH13_AA 1812433253UL
#define BOROSH13_MM 0xffffffffUL         /* 2 ^ 32 - 1 */
...
ran_get (void *vstate)
{
  ...
  state->x = (BOROSH13_AA * state->x) & BOROSH13_MM;
...
const gsl_rng_type *gsl_rng_borosh13 = &borosh13::ran_type;
