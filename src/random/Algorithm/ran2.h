...
#define N_SHUFFLE 32
#define RAN2_N_DIV (1 + 2147483562/N_SHUFFLE)
...
ran2_get (void *vstate)
{
  ...
  {
    unsigned long int j = state->n / RAN2_N_DIV;
...
const gsl_rng_type *gsl_rng_ran2 = &ran2_space::ran2_type;
