...
#define MT_LCG(x) ((69069 * x) + 1) &0xffffffffUL
...
const gsl_rng_type *gsl_rng_mt19937 = &mtspace::mt_type;
const gsl_rng_type *gsl_rng_mt19937_1999 = &mtspace::mt_1999_type;
const gsl_rng_type *gsl_rng_mt19937_1998 = &mtspace::mt_1998_type;

/* MT19937 is the default generator, so define that here too */

const gsl_rng_type *gsl_rng_default = &mtspace::mt_type;
