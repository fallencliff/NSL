...
namespace waterman14_space
{
	#define WATERMAN14_AA 1566083941UL
#define WATERMAN14_MM 0xffffffffUL         /* 2 ^ 32 - 1 */
...
ran_get (void *vstate)
{
  ...
  state->x = (WATERMAN14_AA * state->x) & WATERMAN14_MM;
...
const gsl_rng_type *gsl_rng_waterman14 = &waterman14_space::ran_type;
